...
<main id="primary" class="site-main container">
    <article class="page-card" style="background:#fff; border:1px solid var(--border-color); border-radius:12px; padding:32px; margin-top:20px; margin-bottom:40px;">
        <h1 style="font-size:24px; font-weight:bold; margin-bottom:20px; border-bottom:1px solid var(--border-color); padding-bottom:12px;">راهنما و سوالات متداول کاربران</h1>

        <div class="entry-content text-justify" style="font-size:15px; color:var(--text-color); line-height:1.8;">
            <h2 style="font-size:16px; font-weight:bold; margin-bottom:8px;">چگونه یک آگهی موفق ثبت کنم؟</h2>
            <p>
            ...
            <h2 style="font-size:16px; font-weight:bold; margin-top:24px; margin-bottom:8px;">ثبت آگهی هزینه دارد؟</h2>
            <p>
